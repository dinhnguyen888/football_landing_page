    ...
    <>
      ...
      <Body>
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="rounded-3xl border-2 border-dashed border-amber-300/80 bg-gradient-to-b from-amber-50/50 via-white to-slate-50 p-8 sm:p-14 text-center space-y-6 shadow-sm card-hover-fx">
            {/* Glowing Golden Trophy Pedestal */}
            <div className="relative inline-block mx-auto">
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-gradient-to-br from-amber-400 via-amber-500 to-orange-500 text-white flex items-center justify-center text-4xl sm:text-5xl shadow-xl shadow-amber-500/25 animate-float-slow">
                <i className="fa-solid fa-trophy"></i>
              </div>
              <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-slate-900 text-amber-300 text-[10px] font-fco font-bold uppercase tracking-wider border border-amber-400/50">
                MÙA 1
              </span>
            </div>

            <div className="space-y-2 max-w-lg mx-auto">
              <h3 className="font-fco font-black text-xl sm:text-2xl uppercase text-slate-900 tracking-wide">
            ...
            <div className="pt-3 flex flex-wrap justify-center gap-3">
              <Link
                to="/dthen/ltd"
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-500 hover:to-indigo-600 text-white font-oswald text-xs sm:text-sm font-bold uppercase tracking-wider transition-all shadow-md shadow-blue-600/25 flex items-center space-x-2 hover:scale-105 btn-shimmer"
              >
              ...
              <Link
                to="/dthen"
                className="px-5 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-oswald text-xs sm:text-sm font-bold uppercase tracking-wider transition-colors"
              >
