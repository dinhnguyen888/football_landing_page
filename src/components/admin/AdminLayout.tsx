          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-oswald text-base sm:text-lg font-black uppercase tracking-wider text-slate-900 dark:text-white">
                  ADMIN PORTAL
                </span>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 hidden sm:block">
                Đang quản lý: <strong className="text-amber-600 dark:text-amber-400 font-semibold">{tournamentName}</strong> ({season})
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            {onSyncCloud && (
              <button
                ...
                onClick={onSyncCloud}
                disabled={isSyncing}
                title="Đồng bộ dữ liệu với Cloud Firestore"
            ...
            <div className="relative group">
              <Link
                ...
                title="Mở giao diện người xem ở tab mới"
              >
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  <i className={`fa-solid ${tab.icon} ${isActive ? 'text-slate-950' : 'text-slate-400'}`}></i>
                  <span>{tab.label}</span>
                </button>
              );
            })}
